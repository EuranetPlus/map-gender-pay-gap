export const config = {
	mapTitle: 'map-gender-pay-gap', // The title of the map, if more than one word, separate by dash, e.g. "income-europe"
	vercelURL: 'map-gender-pay-gap.vercel.app', // The url provided when deploying the map on Vercel
